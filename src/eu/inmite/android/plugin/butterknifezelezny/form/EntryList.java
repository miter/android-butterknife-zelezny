...
public class EntryList extends JPanel implements FocusListener {
    ...
    protected JTextField mHolderNameTextField;
    protected Color mHolderDefaultColor;
    protected JTextField mMethodNameTextField;
    protected JLabel mMethodNameLabel;
    ...
    protected void addButtons() {
		...
		*/
        ...
        mHolderNameTextField = new JTextField();
        mHolderNameTextField.setPreferredSize(new Dimension(50,26));
        mHolderNameTextField.setMaximumSize(new Dimension(Short.MAX_VALUE,26));
        mHolderNameTextField.setText("ViewHolder");
        mHolderNameTextField.setEnabled(mCreateHolder);
        mHolderNameTextField.addFocusListener(this);
        mHolderDefaultColor = mHolderNameTextField.getBackground();

        mMethodNameLabel = new JLabel();
        mMethodNameLabel.setText("Method Name:");
        mMethodNameTextField = new JTextField();
        mMethodNameTextField.setPreferredSize(new Dimension(50, 26));
        mMethodNameTextField.setMaximumSize(new Dimension(Short.MAX_VALUE,26));
        mMethodNameTextField.setText("initViews");
        mMethodNameTextField.addFocusListener(this);
        ...
        holderPanel.add(mMethodNameLabel);
        holderPanel.add(mMethodNameTextField);
        holderPanel.add(mHolderCheck);
        holderPanel.add(mHolderLabel);
        holderPanel.add(mHolderNameTextField);
    ...
    protected boolean checkValidity() {
        ...
        boolean holderName = Utils.checkValidity(mHolderNameTextField.getText());
        if (holderName) {
            mHolderNameTextField.setBackground(mHolderDefaultColor);
        } else {
            mHolderNameTextField.setBackground(new Color(0x880000));
        }

        boolean methodName = Utils.checkValidity(mMethodNameTextField.getText());
        if (methodName) {
            mMethodNameTextField.setBackground(mHolderDefaultColor);
        } else {
            mMethodNameTextField.setBackground(new Color(0x880000));
        }
        return valid && holderName && holderName;
    }
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (valid) {
                if (mConfirmListener != null) {
                    mConfirmListener.onConfirm(mProject, mEditor, mElements, mPrefix, mCreateHolder, mHolderNameTextField.getText(),mMethodNameTextField.getText());
                }
            }
        }
    }
